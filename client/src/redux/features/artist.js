...
export const getArtists = createAsyncThunk("artist/getArtists", async (_, { rejectWithValue }) => {
    try {
...
export const addArtist = createAsyncThunk("artist/addArtist", async (body, { rejectWithValue }) => {
    try {
...
export const deleteArtist = createAsyncThunk("artist/deleteArtist", async (id, { rejectWithValue }) => {
    try {
...
const artistSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            // Read
            .addCase(getArtists.pending, (state) => { state.isLoading = true })
            ...
            // Create
            .addCase(addArtist.pending, (state) => { state.isLoading = true })
