...
// Async Thunks
export const getAdmins = createAsyncThunk("admin/getAdmins", async (_, { rejectWithValue }) => {
    try {
...
export const addAdmin = createAsyncThunk("admin/addAdmin", async (body, { rejectWithValue }) => {
    try {
...
const adminSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            // Read
            .addCase(getAdmins.pending, (state) => { state.isLoading = true; })
            ...
            // Create
            .addCase(addAdmin.pending, (state) => { state.isLoading = true; })
